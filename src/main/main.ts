//Libs
import { app, BrowserWindow, ipcMain, clipboard, shell, systemPreferences, Notification } from "electron"
...
function setupIpcHandlers(): void {
  ...
  ipcMain.on("select-color", (_event, color: { hex: string; rgb: string; hsl: string; hsv: string; selectedFormatText?: string }) => {
